...
const registerUserInDB = (userData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield auth_model_1.default.isUserExistByEmail(userData.email);
    if (user) {
...
const loginUserInDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!(yield auth_model_1.default.isUserExistByEmail(payload === null || payload === void 0 ? void 0 : payload.email)) ||
        !(yield auth_model_1.default.isPasswordMatched(payload === null || payload === void 0 ? void 0 : payload.password, user === null || user === void 0 ? void 0 : user.password)) ||
