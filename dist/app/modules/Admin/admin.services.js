...
const blockUserFormAdmin = (id, userId) => __awaiter(void 0, void 0, void 0, function* () {
    // Check if user already exists in the database
    const admin = yield auth_model_1.default.isUserExistById(id);
    ...
    const result = yield auth_model_1.default.findByIdAndUpdate(userId, { isBlocked: true }, {
        new: true,
    });
    if (!result) {
...
const deleteBlog = (blogId, userId, role) => __awaiter(void 0, void 0, void 0, function* () {
